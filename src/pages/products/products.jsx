...
const Products = (props) => {
  ...
  useEffect(() => {
    const productsFilters = document.querySelectorAll(
      ".product__cards__filter__item"
    );
    const addActive = () => {
          ...
          {subcategory.name ? (
            <>
              ...
              <div className="products__filter__toggle w-full py-3 mt-8">
                ...
                <span className="products__filter__toggle__txt ms-2 font-serif font-medium text-inner text-dark">
                  Фильтры
                </span>
              </div>
              <div className="products__inner flex justify-between mt-4 lg:mt-10">
                <div className="products__filter p-4 me-4">
                  <form className="product__filter__form">
                    ...
                    <div className="product__filter__brand mt-8">
                      ...
                      <input
                        type="text"
                        className=" my-3 product__filter__search w-full text-inner font-serif font-medium py-3 px-4 ms-auto"
                        placeholder="Поиск"
                      />
                      <div className="products__brands">
                        <div className="product__brand inline-flex justify-between">
                          <input
                            ...
                            name=""
                            id=""
                            className="products__brands__check"
                          />
                          <span className="products__brands__name ms-2 text-normal font-serif font-medium">
                            Braer
                          </span>
                        </div>
                      </div>
                    ...
                    <Button className="product__filter__btn my-3">
                      Применить
                    </Button>
                    <Button className="product__filter__btn product__filter__reset__btn my-3">
                      Сбросить
                    </Button>
                  </form>
                </div>
                <div className="products__cards">
                  <ul className="products__cards__filter flex flex-wrap">
                    <li className="product__cards__filter__item font-serif font-medium  text-normal">
                      Популярные
                    </li>
                    <li className="product__cards__filter__item font-serif font-medium  text-normal">
                      Дешевле
                  ...
                  <div className=" mt-4 product__cards__wrapper grid grid-cols-2  md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-5">
                    {subcategory.products?.length ? (
                      subcategory.products.map((item) => (
                        <div key={item.product_id} className="product__card">
                          ...
                          <div className="product__card__body">
                            <p
                              className="product__card__txt text-normal font-serif font-medium text-dark"
                              onClick={() =>
                            ...
                            <span className="product__card__price text-extra-dark">
                              {item.price}
                            </span>
                          </div>
                          <div className="product__card__footer">
                            <Button
                              ...
                              onClick={() => addBasket(item.product_id)}
                            >
                              В корзину
                            </Button>
                          </div>
                      ...
                      <p className="text-extra-dark text-title font-serif font-bold">
                        Products not found
                      </p>
                    )}
                  </div>
              ...
              <div className="product__card__pagination flex justify-center mt-4">
                <div className="product__pagination__btn inline-flex justify-center items-center">
                  <img src={prevArrow} alt="arrow prev" />
                </div>
                <ul className="product__pagination__list flex">
                  <li className="product__pagination__item product__pagination__btn text-inner font-serif font-medium text-dark inline-flex justify-center items-center ms-1">
                    1
                  </li>
                  <li className="product__pagination__item product__pagination__btn text-inner font-serif font-medium text-dark inline-flex justify-center items-center ms-1">
                    1
                ...
                <div className="product__pagination__btn inline-flex justify-center items-center ms-1">
                  <img src={nextArrow} alt="arrow next" />
                </div>
              </div>
            </>
          ) : (
            <p className="text-center text-title font-serif font-bold text-dark">
