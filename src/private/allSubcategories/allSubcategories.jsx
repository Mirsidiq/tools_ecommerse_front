...
const AllSubCategories = () => {
  ...
  <div className="users">
   <div className="container">
    <h2 className="users__title text-title text-dark font-serif font-bold my-10">Subcategories</h2>
    <Button variant="contained" className="w-full" color="success" onClick={handleOpen}>Add Subcategory</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
            ...
            <TextField sx={{mt:3}} id="standard-basic" className="w-full" label="subcategory name" variant="standard" />
